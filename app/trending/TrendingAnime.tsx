            ...
            <div className="flex items-center justify-around">
                {anime.slice(0,5).map((item:Anime)=>(
                   <Link key={item.mal_id} href={`/anime/${item.mal_id}`}>
                    <div  className="relative flex flex-col items-center bg-[#1a1a1a] w-[280px] h-full p-4 rounded-lg m-2 hover:scale-105 transition-transform duration-200 overflow-hidden">
