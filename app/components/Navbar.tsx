        ...
        <>
            <nav className={`setup  w-full fixed sm:relative top-0 z-[200] px-4 py-2.5  md:px-20 md:py-10`}>
                ...
                <div className="w-full flex items-center justify-between">
                    ...
                    <motion.button onClick={toggleMenu} aria-expanded={isMenuOpen} className={`rounded-2xl ${isMenuOpen ? 'rotate-45':'rotate-0'} transition-all duration-300 p-3 opacity-100 md:opacity-0`}>
