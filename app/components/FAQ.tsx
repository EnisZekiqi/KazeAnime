...
const FAQ = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row items-start justify-between w-full gap-10 md:gap-0"
    >
      <motion.div
      ...
      >
        ...
        <h1 className="font-normal text-[38px] sm:text-5xl text-white">FAQs</h1>
      </motion.div>
      <motion.div
        variants={itemVariants}
